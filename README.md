...
```
  ...
  * [tests](https://github.com/kelvinnmuia/AirBnB_clone/tree/master/tests)
...
```
  ...
  * [models/__init__.py](https://github.com/kelvinnmuia/AirBnB_clone/blob/master/models/__init__.py)
  * [models/base_model.py](https://github.com/kelvinnmuia/AirBnB_clone/blob/master/models/base_model.py)
  * [tests](https://github.com/kelvinnmuia/AirBnB_clone/tree/master/tests)
...
```
  ...
  * [models/engine/file_storage.py](https://github.com/kelvinnmuia/AirBnB_clone/blob/master/models/engine/file_storage.py)
  * [models/engine/__init__.py](https://github.com/kelvinnmuia/AirBnB_clone/blob/master/models/engine/__init__.py)
  * [models/__init__.py](https://github.com/kelvinnmuia/AirBnB_clone/blob/master/models/__init__.py)
  * [models/base_model.py](https://github.com/kelvinnmuia/AirBnB_clone/blob/master/models/base_model.py)
  * [tests](https://github.com/kelvinnmuia/AirBnB_clone/tree/master/tests)
...
```
  ...
  * [console.py](https://github.com/kelvinnmuia/AirBnB_clone/blob/master/console.py)
...
```
  ...
  * [console](https://github.com/kelvinnmuia/AirBnB_clone/blob/master/console.py)
...
```
  ...
  * [models/user.py](https://github.com/kelvinnmuia/AirBnB_clone/blob/master/models/user.py)
  * [models/engine/file_storage.py](https://github.com/kelvinnmuia/AirBnB_clone/blob/master/models/engine/file_storage.py)
  * [console.py](https://github.com/kelvinnmuia/AirBnB_clone/blob/master/console.py)
  * [tests](https://github.com/kelvinnmuia/AirBnB_clone/tree/master/tests)
...
Write all those classes that inherit from `BaseModel`:
  ...
  * [models/state.py](https://github.com/kelvinnmuia/AirBnB_clone/blob/master/models/state.py)
  * [models/city.py](https://github.com/kelvinnmuia/AirBnB_clone/blob/master/models/city.py)
  * [models/amenity.py](https://github.com/kelvinnmuia/AirBnB_clone/blob/master/models/amenity.py)
  * [models/place.py](https://github.com/kelvinnmuia/AirBnB_clone/blob/master/models/place.py)
  * [models/review.py](https://github.com/kelvinnmuia/AirBnB_clone/blob/master/models/review.py)
  * [tests](https://github.com/kelvinnmuia/AirBnB_clone/tree/master/tests)
...
Otherwise, you will have to re-write the console by replacing `precmd` by `default`.
  ...
  * [tests/test_console.py](https://github.com/kelvinnmuia/AirBnB_clone/blob/master/tests/test_console.py)
